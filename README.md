...
Plugin faqmulti (Faq multiple) for Magix CMS 3
 ...
 * Cliquer sur l'onglet plugins du menu déroulant pour sélectionner faqmulti.
...
```smarty
{faqmulti_data controller='pages' root="pages" id_module=$pages.id}
{include file="faqmulti/brick/faqmulti.tpl" orientation="top"}
````
